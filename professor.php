                    ...
                    <table class="table align-items-center mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="p-2 text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Subject</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            foreach ($profesdata as $key => $profesdataval)
                            {
                                ...
                                echo ' <tr>
                                    <td class="p-2">'.$sn.'</td>
                                    <td class="p-2">'.$profesdataval["name"].'</td>
                                    <td class="p-2">'.$profesdataval["subject"].'</td>
                                </tr>';
                            }
                            ?>
                        </tbody>
