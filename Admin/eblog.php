<?php if(isset($_GET['og'])) { 
    require "modal/header.php";
    
    $code = $_GET['og'];
    $blogquery = $con->query("SELECT * FROM blog WHERE code = '$code' ");
    $html = '';
            ...
            <div class="card p-3">
                ...
                <form action='controller/update.php' method='POST' enctype="multipart/form-data" >
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name='title' value='<?php echo $title ?>' id="coursetitle">
                    </div>
                        <input type="hidden" class="form-control" value='<?php echo $code ?>' name='blogid'>
                        <input type="hidden" class="form-control" name='prev_img' value='<?php echo $image ?>'>

                    <div class="mb-3">
                        <label for="" class="form-label">Short Description</label>
                        <textarea class="form-control" name="description" id="desc" rows="3"><?php echo $description ?></textarea>
                    </div>
