            ...
            <div class="mb-3">
                <div class="row">
                    <div class="col-6">
                        ...
                        <input type="text" placeholder='Eg: Department of BCA' class="form-control" name='coursetitle' id="coursetitle">
                    </div>
                    <div class="col-6">
                        <label for="coursetitle" class="form-label">Semester / Year </label>
                        <input type="number" placeholder='Eg: 8' class="form-control" name='semester' >
                    </div>
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <select class='form-select' name="facutly" >
                    ...
                    foreach($facultydata as $key => $facultydataval){
                        echo '<option value="'.$facultydataval['id'].'">'.$facultydataval['name'].'</option>';
                    }?>
